...
public class Main {
    ...
    public static DocumentVO transformExcelRowToDocument(Row row) {
        ...
        int pos = 0;
        DocumentVO document = new DocumentVoBuilder().build();
        /*while (cellIterator.hasNext()) {
            ...
            switch (pos) {
                ...
                case REQUIERE_DIGITALIZAR:
                    document.setRequiereDigitalizar(cell.getStringCellValue());
                    break;
                case REQUIERE_DISTRIBUCIONFISICA:
                    document.setRequiereDistribucionFisica(cell.getStringCellValue());
                    break;
            }
            pos++;
        }*/
