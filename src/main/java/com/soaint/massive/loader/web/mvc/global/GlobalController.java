package com.soaint.massive.loader.web.mvc.global;
...
import com.soaint.massive.loader.web.infrastructure.util.constants.EstadoSubserieEnum;
...
import com.soaint.massive.loader.web.infrastructure.builder.generic.CheckBoxItemBuilder;
import com.soaint.massive.loader.web.infrastructure.builder.generic.HTTPResponseBuilder;
import com.soaint.massive.loader.web.infrastructure.builder.generic.SelectItemBuilder;
import com.soaint.massive.loader.web.infrastructure.common.CheckBoxItem;
import com.soaint.massive.loader.web.infrastructure.common.HTTPResponse;
import com.soaint.massive.loader.web.infrastructure.common.SelectItem;
import com.soaint.massive.loader.web.infrastructure.util.constants.EstadoSeriesEmun;
...
public class GlobalController {
    ...
    public List<CheckBoxItem> getCaracteristicasList() {
        return CheckBoxItemBuilder.newBuilder()
                .addItem("carTecnica", "T&eacute;cnica", 8)
                .addItem("carLegal", "Legal", 9)
